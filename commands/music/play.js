...
module.exports = {
  ...
  execute: async(client, message, args) => {
    ...
    if(!args[0]) return message.channel.send('You didnt provide a song to play!')
    ...
    var timeString = date.toISOString().substr(11, 8);
      ...
      if (server) {
        ...
        .addField(' <a:mincraft:926503683666096179> Name', song.title, true)

                  .setThumbnail(song.thumbnail)

        .addField('<a:UY98_codm_kekview:926502925277204541> Views', song.views, true)

        .addField('<a:warning1:927868348077867068> Reqeusted By', song.requester, true)
...

    {
      ...
      var prefix1 = ".";
        ...
        .setTitle('Started Playing', song.title, true)

        .setThumbnail(song.thumbnail)

        .addField(' <a:mincraft:926503683666096179> Name', song.title, true)

        .addField('<a:warning1:927868348077867068> Requested By', song.requester, true)

        .addField('<a:UY98_codm_kekview:926502925277204541> Views', song.views, true)

        .addField('<a:DQ99_codm_timer60s:926503325006983189> Duration', timeString, true)
